...
impl Storage {
    ...
    pub fn list_account_metadata_by_ids(&self, account_ids: &[String]) -> Result<Vec<AccountMetadata>> {
    ...
    pub(super) fn ensure_account_metadata_table(&self) -> Result<()> {
        ...
        self.ensure_column("account_metadata", "note", "TEXT")?;
        self.ensure_column("account_metadata", "tags", "TEXT")?;
        self.ensure_column("account_metadata", "updated_at", "INTEGER NOT NULL DEFAULT 0")?;
        Ok(())
    }
}
