...
pub(crate) fn apply_candidate_rotation(
    ...
    super::route_hint::apply_route_strategy_with_storage(storage, candidates, key_id, model_for_log);
    CandidateRotationPlan {
...
mod tests {
    ...
    fn apply_candidate_rotation_reports_binding_source_when_binding_selected() {
        ...
        let plan =
            apply_candidate_rotation(None, &mut candidates, Some(&routing), "key-hash-1", Some("gpt-5.4"));
